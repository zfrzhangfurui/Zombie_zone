...
var Game = function (gameName, canvasId) {
   ...
   this.mouse_on_canvas_x;
   this.mouse_on_canvas_y;
   ...
   window.onkeyup  = function (k) { self.keyPressed_keyup(k); };
...
Game.prototype = {
  ...
  windowToCanvas:function (x, y){
			var bbox = this.canvas.getBoundingClientRect();
				...
				this.mouse_on_canvas_x = x - bbox.left * (this.canvas.width / bbox.width);
				this.mouse_on_canvas_y = y - bbox.top * (this.canvas.height / bbox.height);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   findKeyListener_keyup: function (key) {
      ...
      for(var i=0; i < this.keyListeners_keyup.length; ++i) {
         var keyAndListener = this.keyListeners_keyup[i],
             currentKey = keyAndListener.key;
         if (currentKey === key) {
            listener = keyAndListener.listener;
         }
